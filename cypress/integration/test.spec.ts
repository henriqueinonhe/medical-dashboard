import { sample, uniqWith } from "lodash";
...
describe("Doctor's Dashboard", () => {
  it("Appointments Calendar", () => {
    ...
    function appointmentTimesOverlap(a1 : Appointment, a2 : Appointment) : boolean {
      ...
      const firstEndTime =  a1.endTime ? Dayjs(a1.endTime) : Dayjs(a1.startTime).add(1, "hour");
      const secondEndTime =  a2.endTime ? Dayjs(a2.endTime) : Dayjs(a2.startTime).add(1, "hour");
